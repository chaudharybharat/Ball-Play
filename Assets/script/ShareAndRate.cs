...
public class ShareAndRate : MonoBehaviour {
    ...
    string subject = "Ball Play share with friend";
    string body = "https://play.google.com/store/apps/details?id=com.supor.test";
 ...
 private static extern void sampleTextMethod (string message);
  ...
  sampleTextMethod (shareMessage);
    ...
    {
#if UNITY_ANDROID
        Application.OpenURL("https://play.google.com/store/apps/details?id=com.supor.test");
#elif UNITY_IPHONE
